...
public class TrelloClient {
    ...
    private URI urlBoards(String userName) {

        return UriComponentsBuilder.fromHttpUrl(trelloConfig.getTrelloApiEndpoint() +
                new StringBuilder("/members/" + userName + "/boards").toString())
    ...
    public CreatedTrelloCardDto createNewCard(TrelloCardDto trelloCardDto) {
        return restTemplate.postForObject(urlCard(trelloCardDto), null, CreatedTrelloCardDto.class);
    }
}
